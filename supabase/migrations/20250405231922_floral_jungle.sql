/*
  # Update podcast policies for admin-only access

  1. Changes
    - Remove general authenticated user management policy
    - Add admin-only management policy
    - Keep public viewing policy

  2. Security
    - Only admin can create/update/delete podcasts
    - Public can still view podcasts
*/
